...
Source0  : https://download.gnome.org/sources/atk/2.34/atk-2.34.0.tar.xz
...
%prep
%setup -q -n atk-2.34.0
pushd ..
cp -a atk-2.34.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568045789
...
/usr/lib64/libatk-1.0.so.0.23312.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libatk-1.0.so.0
/usr/lib32/libatk-1.0.so.0.23312.1
