...
Source0  : https://download.gnome.org/sources/atk/2.28/atk-2.28.1.tar.xz
...
%prep
%setup -q -n atk-2.28.1
pushd ..
cp -a atk-2.28.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1522116115
...
/usr/lib32/libatk-1.0.so.0.22810.1
