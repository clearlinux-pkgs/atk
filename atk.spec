...
Source0  : https://download.gnome.org/sources/atk/2.32/atk-2.32.0.tar.xz
...
%prep
%setup -q -n atk-2.32.0
pushd ..
cp -a atk-2.32.0 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1556992473
export AR=gcc-ar
...
/usr/lib64/libatk-1.0.so.0.23209.1

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libatk-1.0.so.0
/usr/lib32/libatk-1.0.so.0.23209.1
